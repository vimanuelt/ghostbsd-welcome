...
class Hello():
    ...
    def __init__(self):
        ...
        # Load preferences
        if self.dev:
            self.preferences = read_json("./xlate/model/data/preferences.json")
            self.preferences["data_path"] = "./xlate/model/data/"
            self.preferences["desktop_path"] = os.getcwd() + "/{}.desktop".format(self.app)
            self.preferences["locale_path"] = "./xlate/model/locale/"
            self.preferences["ui_path"] = "./render/model/ui/{}.glade".format(self.app)
        else:
